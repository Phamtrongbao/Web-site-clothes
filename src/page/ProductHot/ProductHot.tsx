...
export default function ProductHot() {
    ...
    const renderProductHot = () => {
        return (
            <Fragment>
                {data?.filter((product:any)=>product.HotProduct).map((product:any, index:any) => {
  ...
  return (
    <div className='container'>
        <div className="line-bottom mt-5"></div>
          <h3 className='mt-1' style={{ textAlign: "center", fontFamily: "sans-serif", fontWeight: 700,color:"red" }}>HOT PRODUCT</h3>
